...
*   **Limitação PDFs PJe:** Anexos como TRCT e Contracheques em PDFs do PJe são referências externas (IDs como "1d47311"), não imagens embutidas. Campos como salário, PIS e data de admissão não podem ser extraídos desses PDFs sem baixar os anexos separadamente do sistema PJe.
